...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="{{ $appLogo ?: asset('assets/icons/favicon.svg') }}">
    ...
    ">
      ...
      ">
            ...
            ">
              ...
              color: #A08980;
            ">Use your
                            email or username to continue.</p>
                    </div>
              ...
              ">Email
                ...
                ">
                  ...
                  "
                            ...
                            @error('login')
                                <p
                                    style="margin-top: 6px; font-size: 12px; color: #D14343; display: flex; align-items: center; gap: 4px;">
          ...
          ">
              ...
              gap: 5px;
            ">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#E2725B"
                                stroke-width="2.5">
