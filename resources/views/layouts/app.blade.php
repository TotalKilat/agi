...
<head>
    ...
    @endphp
    @if ($faviconUrl)
        <link rel="icon" type="image/{{ pathinfo($faviconUrl, PATHINFO_EXTENSION) === 'svg' ? 'svg+xml' : 'png' }}"
            href="{{ $faviconUrl }}">
    @else
        ...
        <form id="agentForm" method="POST" action="{{ route('agents.store') }}">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-input" placeholder="e.g. Customer Support AI"
                        required>
                </div>
