    ...
    <div class="navbar-right">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" id="notificationDropdown" style="min-width: 320px;">
                <div style="padding: 10px 12px; font-size: 13px; font-weight: 600; color: var(--color-text-primary);">
                    Notifications</div>
        ...
        {{-- User Menu --}}
        <div class="dropdown">
            <button class="navbar-icon-btn" id="userMenuBtn" title="User menu"
                style="gap: 8px; width: auto; padding: 4px 8px;">
            ...
            <div class="dropdown-menu" id="userDropdown">
                <div style="padding: 10px 12px; border-bottom: 1px solid var(--color-border-light);">
                    ...
                    <div style="font-size: 11px; color: var(--color-text-muted);">
                        {{ Auth::user()->email ?? 'alex@agentix.ai' }}</div>
                </div>
                ...
                <button class="dropdown-item" onclick="window.location='{{ route('settings.edit') }}'">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="2">
