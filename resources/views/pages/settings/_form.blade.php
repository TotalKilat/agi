    ...
    <div class="settings-card">
        ...
        <div class="form-group">
            ...
            <input type="text" name="app_name" id="app_name"
                ...
                value="{{ old('app_name', $settings['app_name'] ?? 'Agentix') }}" maxlength="100" required>
            @error('app_name')
        ...
        <div class="form-group">
            ...
            <div style="display:flex; align-items:flex-start; gap:20px; flex-wrap:wrap;">
                <div class="logo-preview-box" id="logoPreviewBox">
                    ...
                    @else
                        <div class="logo-preview-placeholder">
                            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#B0A098"
                                stroke-width="1.5">
                                <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />
                                <circle cx="8.5" cy="8.5" r="1.5" />
                                <polyline points="21 15 16 10 5 21" />
                ...
                <div style="flex:1; min-width:200px;">
                    ...
                    @if ($logoUrl)
                        <label
                            style="margin-top:8px; display:flex; align-items:center; gap:6px; font-size:13px; cursor:pointer;">
                ...
                <div class="favicon-preview-box" id="faviconPreviewBox">
                    ...
                    @else
                        <div class="favicon-preview-placeholder">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#B0A098"
                                stroke-width="2">
