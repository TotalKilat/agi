...
@section('content')
    <div class="page-section active js-crud-page" id="fleetIndexPage" data-csrf-token="{{ csrf_token() }}"
            ...
            <div class="card">
                ...
                <div class="data-table-container">
                    <table class="table js-data-table" id="fleetTable" data-url="{{ route('fleets.data') }}"
                        data-enrichment-url="{{ route('fleets.latest-positions') }}" data-order='[[2,"asc"]]'
        ...
        <x-modal id="fleetSyncModal" title="Synchronize Fleets">
            <form method="POST" action="{{ route('fleets.sync') }}" class="js-async-form"
                data-success-title="Synchronization complete">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for="sync_customer_id" class="form-label">Customer</label>
                        <select name="customer_id" id="sync_customer_id" class="form-select js-select2"
        ...
        <x-modal id="fleetEditModal" title="Edit Fleet" size="xl">
            <form method="POST" action="" class="js-async-form js-fleet-edit-form"
                data-success-title="Fleet updated" data-loading-text="Saving...">
                @csrf
                @method('PUT')
                <div class="modal-body">
            ...
            <div class="map-modal-shell">
                ...
                <div class="map-modal-content">
                    <div class="map-modal-frame-card">
                        <iframe class="map-modal-frame" data-map-frame src="about:blank" title="Vehicle location map"
                    ...
                    <aside class="map-modal-details" aria-label="Vehicle position details">
                        ...
                        <div class="map-detail-card">
                            ...
                            <strong class="map-detail-value map-detail-coordinate"
                                data-map-coordinates>Unavailable</strong>
                        </div>
                    </aside>
                </div>
            </div>
