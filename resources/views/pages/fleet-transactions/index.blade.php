...
>
    ...
    <div class="card">
      ...
      <div class="data-table-container">
        <table
          ...
          id="fleetTransactionTable"
          data-url="{{ route('fleet-transactions.data') }}"
          data-order='[[3,"desc"]]'
          data-plural-label="transactions"
          data-search-placeholder="Search transactions..."
        >
          <thead>
            <tr>
  ...
  <x-modal id="fleetTransactionImportModal" title="Upload Transactions">
    <form
      method="POST"
      action="{{ route('fleet-transactions.import') }}"
      class="js-async-form"
      data-success-title="Import complete"
    ...
    >
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          >
          <div class="form-hint">
            Upload the Daily Performance Analysis Report export. Vehicle names in the file must already exist in Fleet.
          </div>
        </div>
      </div>
