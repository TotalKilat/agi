...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        $menus = [
            ...
            ['name' => 'Settings', 'section' => 'Workspace', 'icon' => 'settings', 'route_name' => 'settings', 'active_pattern' => 'settings', 'sort_order' => 10],
            ['name' => 'Menu Management', 'section' => 'Workspace', 'icon' => 'menu', 'route_name' => 'menus.index', 'active_pattern' => 'menus.*', 'sort_order' => 20],
        ];
